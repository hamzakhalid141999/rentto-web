    ...
    <>
      <div className={classes.features_section}>
        <div className={classes.content_container}>
          ...
          >
            <div data-aos="fade-right" className={classes.card_imgs_container}>
          ...
          >
            <div data-aos="fade-left" className={classes.card_imgs_container}>
              <img src={bypass_agents_bg.src} className={classes.card_img_bg} />
              <img
                style={{ top: "-20px" }}
            ...
            >
              ...
              <p>
                Through bypassing Property Agents RenttoApp enables transparency
                and a hasslefree expereince. By bridging the gap between
                Property Owners and Tenants a smooth and trouble-free process
                can be initiated.
                <br />
                <br />
          ...
          <div className={classes.content_section}>
            ...
            <div data-aos="fade-left" className={classes.description_container}>
              ...
              <p>
                ...
                RenttoApp are genuine and authentic. Furthermore, the quality of
                an Ad is determined by our algoritham and an approriate Ad life
                is accordingly ascertained.
                <br />
                <br />
              ...
              <p>
                “ Modern features such as 360 visualization makes the process of
                shortlisting properties from a vast pool of genuine properties
                fast and effective. ”
              </p>
      ...
      <div className={classes.features_section}>
        ...
        <div className={classes.content_container}>
          <h1 style={{ marginTop: "200px" }} data-aos="fade-up">
          ...
          >
            ...
            <div data-aos="fade-left" className={classes.description_container}>
              ...
              <p>
                RentoApp gives Property Owners the freedom to list their vacant
                properties free of cost. A step by step smooth process
                facilitates the property owners to provide accurate, correct and
                useful information.
                <br />
                <br />
                Video tutorials are available to facilitate the Ad uploading
                process.
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <p>
                Property Owners seeking assistance to upload their property Ads
                without any difficulty can always reach out to our “Assistance
                Team”.
                <br />
                <br />
                ...
                <br />
                <br />
                “the assistance team were very professional and helpful. The Ad
                listing prepared by them will be useful for me in the furture as
                well when I re-rent my property again.”
              </p>
            </div>
          </div>
          <div className={classes.content_section}>
            ...
            <div data-aos="fade-left" className={classes.description_container}>
              ...
              <p>
                ...
                avail our complete range of services on an annual and reccuring
                basis.
              </p>
              <div
